...
def googlenet(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> "GoogLeNet":
    ...
    if pretrained:
        ...
        for key in list(state_dict.keys()):
            if "aux" in key and "fc1" in key:
                split_key = key.split(".")
                new_key = split_key[0]+"."+split_key[1]+".fc."+split_key[2]
...
class GoogLeNet(nn.Module):
    ...
    def __init__(
        ...
        if blocks is None:
            blocks = [convbnrelu_block, Inception, InceptionAux]
...
class InceptionAux(nn.Module):
    ...
    def __init__(
        ...
        self.fc1 = fc_block(2048, 1024) #nn.Linear(2048, 1024)
