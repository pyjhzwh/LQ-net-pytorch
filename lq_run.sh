...
for i in "${bitsets[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=0 python3 main.py --arch alexnet --dataset imagenet --lr 1e-3 --epochs 200 --wd 1e-5 --lq  --bits ${i} --needbias --block_type convrelubn --lr_epochs 50  2>&1 | tee "${DIR}/alexnet_${i}_from_stretch_convrelubn.log"
