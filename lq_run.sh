...
for i in "${bitsets[@]}"; do
    ...
    # all_cnn_net
    #CUDA_VISIBLE_DEVICES=0 python3 main.py --arch ${ARCH} --dataset ${DATASET} --lr 1e-2 --epochs 500 --wd 1e-4 --lq  --bits ${i} --lr_epochs 150 --needbias #2>&1 | tee "${DIR}/${ARCH}_${i}_from_stretch_convbnrelu.log"
    # alexnet
    #CUDA_VISIBLE_DEVICES=0 python3 main.py --arch ${ARCH} --dataset ${DATASET} --lr 1e-3 --epochs 50 --wd 1e-4 --lq  --bits ${i} --lr_epochs 30  --needbias #2>&1 | tee "${DIR}/${ARCH}_${i}_from_stretch_convbnrelu.log"
    # resnet18
    ...
    # googlenet
    #CUDA_VISIBLE_DEVICES=1 python3 main.py --arch ${ARCH} --dataset ${DATASET} --lr 1e-4 --epochs 10 --wd 1e-4 --lq  --bits ${i} --lr_epochs 30 --needbias #2>&1 | tee "${DIR}/${ARCH}_${i}_from_stretch_convbnrelu.log"
    # squeezenet
    CUDA_VISIBLE_DEVICES=1 python3 main.py --arch ${ARCH} --dataset ${DATASET} --lr 1e-4 --epochs 30 --wd 1e-4 --lq  --bits ${i} --lr_epochs 30 --needbias #2>&1 | tee "${DIR}/${ARCH}_${i}_from_stretch_convbnrelu.log"
    # vgg
