...
for i in "${bitsets[@]}"; do
    ...
    #CUDA_VISIBLE_DEVICES=2,3 python3 main.py --arch all_cnn_c --dataset cifar10 --lr 1e-2 --epochs 500 --wd 1e-3 --lq  --bits ${i} --lr_epochs 100 --pretrained  saved_models/best.all_cnn_c.32.32.ckp_origin.pth.tar 2>&1 | tee ${DIR}/lqnet.pretrained.log 
    CUDA_VISIBLE_DEVICES=3 python3 main.py --arch all_cnn_c --dataset cifar10 --lr 1e-2 --epochs 500 --wd 1e-3 --lq  --bits ${i} --lr_epochs 100  2>&1 | tee ${DIR}/all_cnn_net_from_stretch.log 
