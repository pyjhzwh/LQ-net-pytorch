...
DS=224
CROP=224
CUDA_VISIBLE_DEVICES=2,3 python3 main.py --ds ${DS} --crop ${CROP} --arch 'resnet18' --dataset 'imagenet' --epochs 100 --lr 1e-3 --lr_epochs 50  &> ${DIR}/small.crop${CROP}.ds${DS}.log -e --show_conf_acc
#COMMENT2
